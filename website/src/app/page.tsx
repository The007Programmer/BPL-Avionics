        ...
        <section id="technology" className="w-full py-32 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="section-dark p-8 rounded-2xl hover:scale-105 transition-transform">
                <h3 className="text-2xl font-bold mb-4">Hybrid Engine Development</h3>
                <ul className="space-y-3 text-[var(--secondary)]">
                  <li>• Casing and fluid systems design</li>
                  <li>• Materials research for heat resistance</li>
                  <li>• Combustion chamber optimization</li>
              ...
              <div className="section-dark p-8 rounded-2xl hover:scale-105 transition-transform">
                ...
                <ul className="space-y-3 text-[var(--secondary)]">
                  <li>• Utilizing telemetry systems</li>
                  <li>• Real-time sensor graphing</li>
